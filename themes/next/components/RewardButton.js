  ...
  return (
    <div className='justify-center'>
      ...
      <div onMouseEnter={openPopover} onMouseLeave={closePopover} id='reward-qrcode' className='hidden flex space-x-10 animate__animated animate__fadeIn duration-200 my-5 px-5 mx-auto py-6 justify-center bg-white dark:bg-black dark:text-gray-200'>
        <div className='w-80'><Image width={320} height={320} className='w-full h-auto' src='/reward_code_alipay.png' alt='Alipay QR code' /></div>
        <div className='w-80'><Image width={320} height={320} className='w-full h-auto' src='/reward_code_wechat.png' alt='WeChat QR code' /></div>
      </div>
    </div>
  )
}
