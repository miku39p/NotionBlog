...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'f6e4e73481564b329c2bf3d87cd24280',
  ...
  GREETING_WORDS:
    ...
    '欢迎来到这个世界,Welcome to this world,ようこそこの世界',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'akami', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '<div>葱葱人<br/>二次元<br/>自由自在</div>', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.39projects.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zhangjake0815@hotmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/miku239p', // 你的twitter个人主页
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'comment.39projects.com', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
