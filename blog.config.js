...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '葱葱人/n二次元/n自由自在', // 作者简介
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://comment.39projects.com', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
